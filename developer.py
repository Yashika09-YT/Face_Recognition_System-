...
class Developer:
    def __init__(self,root):
        ...
        img_top= Image.open(r"Images\dface.jpg")
        ...
        img_top1= Image.open(r"Images\developerFace.jpg")
        ...
        dev_label = Label(main_frame,text="I'm Yashika Tanwar",font=("Helvetica", 20, "bold"),bg="white")
